...
def nizk_prove(sk: int, id: str, mid: str, g, gw, a1, a0) -> tuple[int, int]:
    r = generate_sk()
    g1 = a1
    ...
    id_mid_bytes = str_to_bytes(id+ mid)
    v = H2(id_mid_bytes)
    w = (sk + v) % order
...
def nizk_verify(id: str, mid: str, g, pk_gv, a1, a0, pi: tuple[int, int]) -> bool:
    z, beta = pi
