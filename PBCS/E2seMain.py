...
def main():
    ...
    if role == Constants.CLIENT:
        ...
        # local_path = config['DEFAULT']['bucketName']
        # print("Local storage path:", local_path)
        ...
        # auth_server_ip = config.get("DEFAULT", "authServerIp", fallback="127.0.0.1")
        # auth_server_port = config.getint("DEFAULT", "authServerPort", fallback=20202)
        # auth_server_name = config.get("DEFAULT", "authServerName", fallback="CN=default")
